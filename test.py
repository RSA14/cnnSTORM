...
from models import conv_1, resnet_model, densemodel
from resnet_models import resnet_test
import trainer
...
#                                                       samples=500)
#MATLAB data
X_train, y_train = data_processing.process_MATLAB_data('PSF_1.mat', 'Zpos_1.mat', normalise_images=True)
...
history = trainer.train_model(resnet_test, x_train=X_train, y_train=y_train,
                              optimizer=keras.optimizers.Adam(learning_rate=0.01),
                              loss='mse', metrics=['mse'], validation_split=0.2,
                              epochs=10, batch_size=32, summary=False)
