...
def train_FOMAML(model, dataset, training_keys,
    ...
    for epoch in range(epochs):
        ...
        for i, key in enumerate(training_keys):
            ...
            test_idx = indices[:int(np.floor(test_proportion * N))]

            inner_N, meta_N = len(train_idx), len(test_idx)
