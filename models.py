...
conv_1 = Sequential()
conv_1.add(Conv2D(8, 3, input_shape=(32, 32, 1)))
...
conv_test = create_CNN(conv=[8, 8, 4], batch_norm=[1, 1, 1], activation=['prelu', 'prelu', 'prelu'],
                       pooling=[(2, 2), (2, 2), (2, 2)], show_summary=True)
