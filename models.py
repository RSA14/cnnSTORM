...
def create_DenseModelB():
    ...
    densemodel.add(keras.layers.Dense(1024, activation=None, kernel_regularizer=regularizers.l2()))
    densemodel.add(keras.layers.ReLU())
    densemodel.add(keras.layers.Dense(512, activation=None, kernel_regularizer=regularizers.l2()))
    densemodel.add(keras.layers.ReLU())
    densemodel.add(keras.layers.Dense(256, activation=None, kernel_regularizer=regularizers.l2()))
    densemodel.add(keras.layers.ReLU())
